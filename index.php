<?php
	session_start();
	try {
		$bdd = new PDO('mysql:host=eu-cdbr-west-03.cleardb.net;dbname=heroku_1e82a0b7ae70a0d;charset=utf8', "bf9399d9b323b2", "2bffc160", array(PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION));
	} catch (Exception $e) {
